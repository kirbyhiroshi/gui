...
async function fetchReports() {
    ...
    try {
        ...
        // データベース接続エラーがJSONとして返された場合
        if (reports.error) {
            listElement.innerHTML = `<p style="color:red;">エラー: ${reports.error}</p>`;
            return;
        }
        ...
        listElement.innerHTML = '<p style="color:red;">日報の読み込みに失敗しました。（ネットワーク/CORSエラーの可能性）</p>';
    }
}
